...
<div id="container" class="clearfix">
    <div id="header">
        <table>
            <tr>
                <td>
                    <h1><a href="https://{{.BaseUrl}}">What Is My IP Address?</a></h1>
                </td>
                <td></td>
            </tr>
            <tr>
    ...
    <div id="info_area">
        ...
        <table id="info_table" summary="info">
            ...
            <tr>
                <td class="info_table_label">QQWry</td>
                <td>{{.QQWry}}</td>
            </tr>
            <tr>
                <td class="info_table_label">Geoip2</td>
                <td>{{.Geoip2}}</td>
            </tr>
            <tr>
                <td class="info_table_label">IPIP.net</td>
                <td>{{.IPIP}}</td>
            </tr>
            <tr>
                <td class="info_table_label">IP2Region</td>
                <td>{{.IP2Region}}</td>
            </tr>
            <tr>
    ...
    <div id="cli_wrap">
        ...
        <table id="cli_table" summary="cli">
            <tr>
                <td class="cli_command">$ curl {{.BaseUrl}}</td>
